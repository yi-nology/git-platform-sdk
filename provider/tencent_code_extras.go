...
type TencentCodeExtras interface {
	...
	GetCodeReviewChangedFiles(ctx context.Context, owner, repo string, reviewID int) ([]*ChangedFile, error)
	...
	GetCommitDiff(ctx context.Context, owner, repo, sha string, opts CommitDiffOptions) ([]*ChangedFile, error)
...
var _ TencentCodeExtras = (*tencentCodeProvider)(nil)
...
func (t *tencentCodeProvider) CreateCodeReview(ctx context.Context, owner, repo string, opts CreateCodeReviewOptions) (*CodeReview, error) {
...
func (t *tencentCodeProvider) ListCodeReviews(ctx context.Context, owner, repo string, opts ListCodeReviewsOptions) ([]*CodeReview, error) {
	encoded := encodeProjectPath(owner, repo)
...
func (t *tencentCodeProvider) GetCodeReview(ctx context.Context, owner, repo string, reviewID int) (*CodeReview, error) {
	encoded := encodeProjectPath(owner, repo)
	var cr CodeReview
...
func (t *tencentCodeProvider) UpdateCodeReview(ctx context.Context, owner, repo string, reviewID int, opts UpdateCodeReviewOptions) (*CodeReview, error) {
	encoded := encodeProjectPath(owner, repo)
	body := map[string]interface{}{"title": opts.Title, "description": opts.Description}
	var cr CodeReview
...
func (t *tencentCodeProvider) InviteCodeReviewer(ctx context.Context, owner, repo string, reviewID int, opts InviteReviewerOptions) error {
	encoded := encodeProjectPath(owner, repo)
	body := map[string]interface{}{}
	if opts.ReviewerID != "" {
...
func (t *tencentCodeProvider) RemoveCodeReviewer(ctx context.Context, owner, repo string, reviewID int, reviewerID string) error {
	encoded := encodeProjectPath(owner, repo)
	q := url.Values{}
...
func (t *tencentCodeProvider) SubmitCodeReview(ctx context.Context, owner, repo string, reviewID int, opts SubmitReviewOptions) error {
	encoded := encodeProjectPath(owner, repo)
	body := map[string]interface{}{"reviewer_event": string(opts.Event), "summary": opts.Summary}
	return t.doRequest(ctx, "PUT", fmt.Sprintf("/projects/%s/review/%d/reviewer/summary", encoded, reviewID), body, nil)
}

func (t *tencentCodeProvider) ReopenCodeReview(ctx context.Context, owner, repo string, reviewID int) error {
	encoded := encodeProjectPath(owner, repo)
	return t.doRequest(ctx, "PUT", fmt.Sprintf("/projects/%s/review/%d/reopen", encoded, reviewID), nil, nil)
}

func (t *tencentCodeProvider) GetCodeReviewChangedFiles(ctx context.Context, owner, repo string, reviewID int) ([]*ChangedFile, error) {
	encoded := encodeProjectPath(owner, repo)
...
func (t *tencentCodeProvider) GetMRReview(ctx context.Context, owner, repo string, mrNumber int) (*MRReview, error) {
	encoded := encodeProjectPath(owner, repo)
	var mr MRReview
...
func (t *tencentCodeProvider) InviteMRReviewer(ctx context.Context, owner, repo string, mrNumber int, opts InviteReviewerOptions) error {
	encoded := encodeProjectPath(owner, repo)
	body := map[string]interface{}{}
	if opts.ReviewerID != "" {
...
func (t *tencentCodeProvider) RemoveMRReviewer(ctx context.Context, owner, repo string, mrNumber int, reviewerID int) error {
	encoded := encodeProjectPath(owner, repo)
	q := url.Values{}
...
func (t *tencentCodeProvider) CancelMRReview(ctx context.Context, owner, repo string, mrNumber int) error {
	encoded := encodeProjectPath(owner, repo)
	return t.doRequest(ctx, "DELETE", fmt.Sprintf("/projects/%s/merge_request/%d/review/cancel", encoded, mrNumber), nil, nil)
}

func (t *tencentCodeProvider) SubmitMRReview(ctx context.Context, owner, repo string, mrNumber int, opts SubmitReviewOptions) error {
	encoded := encodeProjectPath(owner, repo)
	body := map[string]interface{}{"reviewer_event": string(opts.Event), "summary": opts.Summary}
	return t.doRequest(ctx, "PUT", fmt.Sprintf("/projects/%s/merge_request/%d/reviewer/summary", encoded, mrNumber), body, nil)
}

func (t *tencentCodeProvider) ReopenMRReview(ctx context.Context, owner, repo string, mrNumber int) error {
	encoded := encodeProjectPath(owner, repo)
...
func (t *tencentCodeProvider) GetCommitDiff(ctx context.Context, owner, repo, sha string, opts CommitDiffOptions) ([]*ChangedFile, error) {
	encoded := encodeProjectPath(owner, repo)
	q := url.Values{}
	if opts.Path != "" {
...
func (t *tencentCodeProvider) ListCommitComments(ctx context.Context, owner, repo, sha string, page, perPage int) ([]*CommitComment, error) {
	encoded := encodeProjectPath(owner, repo)
	page, perPage = NormalizePageOpts(page, perPage)
...
func (t *tencentCodeProvider) CreateCommitComment(ctx context.Context, owner, repo, sha string, opts CreateCommitCommentOptions) (*CommitComment, error) {
	encoded := encodeProjectPath(owner, repo)
	body := map[string]interface{}{"note": opts.Note}
	if opts.Path != "" {
		body["path"] = opts.Path
	}
	if opts.Line > 0 {
...
func (t *tencentCodeProvider) GetCommitRefs(ctx context.Context, owner, repo, sha string, refType CommitRefType) (*CommitRefs, error) {
	encoded := encodeProjectPath(owner, repo)
	q := url.Values{}
	if refType != "" {
...
func (t *tencentCodeProvider) GetRepoTree(ctx context.Context, owner, repo, path, ref string, recursive bool) ([]*TreeEntryNode, error) {
	encoded := encodeProjectPath(owner, repo)
	q := url.Values{}
	if path != "" {
		q.Set("path", path)
...
func (t *tencentCodeProvider) GetBlob(ctx context.Context, owner, repo, sha string) ([]byte, error) {
	encoded := encodeProjectPath(owner, repo)
...
func (t *tencentCodeProvider) ProtectBranch(ctx context.Context, owner, repo, branch string, opts ProtectBranchOptions) error {
	encoded := encodeProjectPath(owner, repo)
	return t.doRequest(ctx, "PUT", fmt.Sprintf("/projects/%s/repository/branches/%s/protect", encoded, url.PathEscape(branch)), nil, nil)
}

func (t *tencentCodeProvider) UnprotectBranch(ctx context.Context, owner, repo, branch string) error {
	encoded := encodeProjectPath(owner, repo)
	return t.doRequest(ctx, "PUT", fmt.Sprintf("/projects/%s/repository/branches/%s/unprotect", encoded, url.PathEscape(branch)), nil, nil)
}

func (t *tencentCodeProvider) ListProtectedBranchMembers(ctx context.Context, owner, repo, branch string) ([]*ProtectedBranchMember, error) {
	encoded := encodeProjectPath(owner, repo)
...
func (t *tencentCodeProvider) AddProtectedBranchMember(ctx context.Context, owner, repo, branch string, opts ProtectedBranchMemberOptions) error {
	encoded := encodeProjectPath(owner, repo)
	body := map[string]interface{}{"user_id": opts.UserID}
...
func (t *tencentCodeProvider) UpdateProtectedBranchMember(ctx context.Context, owner, repo, branch string, userID int, opts ProtectedBranchMemberOptions) error {
	encoded := encodeProjectPath(owner, repo)
	body := map[string]interface{}{}
	if opts.AccessLevel != 0 {
		body["access_level"] = opts.AccessLevel
...
func (t *tencentCodeProvider) RemoveProtectedBranchMember(ctx context.Context, owner, repo, branch string, userID int) error {
	encoded := encodeProjectPath(owner, repo)
