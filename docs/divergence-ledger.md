...
| IssueManager | CreateIssue | opts.Assignees | ignore | Assignees are username-addressed by the SDK while GitLab writes need user IDs; the resolver is not wired. |
