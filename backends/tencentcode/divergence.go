...
// divergences is the TencentCode divergence ledger: the registered places where
...
// Divergences returns the registered divergence ledger for the TencentCode backend.
