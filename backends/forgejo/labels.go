...
// addresses them by name. Labels are scanned with server-side pagination
// (100 per page, bounded to 50 pages); a label beyond that bound may be
// reported as not found even though it exists. op is the public operation
// the resolution serves; failures surface under that op rather than under
// this unexported helper's name. The forgejo SDK's label methods accept no
